...
Files: scene.gltf [211.83KB] > /Users/matthewdavis/Downloads/buster_drone/scene-transformed.glb [3.19MB] (-1408%)
...
export function Drone(props: any) {
  ...
  return (
    <group
      ...
      onPointerDown={(e) => {
        ...
        group.current!.position.copy(e.point);
      }}
      onPointerMove={(e) => {
        if (!isDraggingRef.current) {
          return;
